    ...
    <section className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-semibold mb-8 leading-tight">
          <span className="text-agic font-bold">AGIC</span>:
        ...
        <div className="mb-8 space-y-4">
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-lg">
            <span className="text-academic-blue hover:text-agic transition-colors cursor-pointer">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <Button variant="default" size="lg" className="bg-primary hover:bg-agic-dark transition-all duration-300 shadow-lg">
